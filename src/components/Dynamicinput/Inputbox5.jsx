...
export const Inputbox5 = () => {
    ...
    const getData4 = (e) => {
        data4[e.target.name] = e.target.value
        setData4(data4)
        // console.log("e");

    }
    const getData5 = (e) => {
        data5[e.target.name] = e.target.value
        setData5(data5)
        // console.log("e");
    ...
    return (
        <>
            <form onSubmit={addData} >
                ...
                <div className='outer'>
                    Epmloyee Name : <input type="text" placeholder="Epmloyee Name ." name='Empname' onChange={getData4} required />
                    Employee Department : <input type="text" placeholder="Employee Department." name='Empdept' onChange={getData4} required />
                </div>
                <div className='outer'>
                    Epmloyee Name : <input type="text" placeholder="Epmloyee Name ." name='Empname' onChange={getData5} required />
                    Employee Department : <input type="text" placeholder="Employee Department." name='Empdept' onChange={getData5} required />
                </div>
                <div className='outer' >
